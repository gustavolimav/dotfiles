# [WORKTREE ADD]
# This function will add a worktree running ant setup-profile-dxp and ij
# Example: worktreeAdd <branch name>
worktreeAdd() {
	emulate -LR bash
...
# [WORKTREE REMOVE]
# This function will remove a worktree and the bundle folder
# Example: worktreeRemove <branch name>
worktreeRemove() {
	emulate -LR bash
		...
		rm -rf /home/me/dev/projects/bundles/$1
}
